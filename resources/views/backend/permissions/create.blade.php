            ...
            <div class="box-body">
                <form method="post" action="{{ route('permissions.store') }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group{{ $errors->has('crud') ? ' has-error' : '' }}">
                            <label class="col-md-2 control-label">CRUD <span style="color:red">*</span> </label>
                            <div class="col-md-6">
                                <input type="checkbox" name="crud" value="1">
                                @if ($errors->has('crud'))
                                    <span class="help-block">
                                        <strong class="help-block">{{ $errors->first('crud') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
