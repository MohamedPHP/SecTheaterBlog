                ...
                <form method="post" action="{{ route('posts.store') }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group{{ $errors->has('tag_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="tag_id[]" multiple>
                                    @foreach ($tags as $t)
                                        <option value="{{ $t->id }}" {{ in_array($t->id, old('tag_id') ?? []) ? 'selected' : '' }}>{{ $t->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="content" class="form-control" placeholder="content" rows="8" cols="80">{{ old('content') }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('keywords') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="keywords" value="{{ old('keywords') }}" class="form-control" placeholder="keywords">
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="description" class="form-control" placeholder="description" rows="8" cols="80">{{ old('description') }}</textarea>
